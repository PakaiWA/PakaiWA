...
import (
	...
	"github.com/PakaiWA/PakaiWA/ent/migrate"
...
func (c *PermissionClient) QueryUser(_m *Permission) *UserQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, permission.UserTable, permission.UserColumn),
		)
...
type (
	hooks struct {
		Permission, User []ent.Hook
	}
	inters struct {
		Permission, User []ent.Interceptor
	}
)
