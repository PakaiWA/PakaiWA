...
func (_c *UserCreate) SetLogoutAt(v time.Time) *UserCreate {
	_c.mutation.SetLogoutAt(v)
	return _c
}

// SetNillableLogoutAt sets the "logout_at" field if the given value is not nil.
func (_c *UserCreate) SetNillableLogoutAt(v *time.Time) *UserCreate {
	if v != nil {
		_c.SetLogoutAt(*v)
	}
	return _c
...
func (_c *UserCreate) defaults() {
	if _, ok := _c.mutation.LogoutAt(); !ok {
		v := user.DefaultLogoutAt()
		_c.mutation.SetLogoutAt(v)
	}
...
func (_c *UserCreate) check() error {
	...
	if _, ok := _c.mutation.LogoutAt(); !ok {
		return &ValidationError{Name: "logout_at", err: errors.New(`ent: missing required field "User.logout_at"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.LogoutAt(); ok {
		_spec.SetField(user.FieldLogoutAt, field.TypeTime, value)
