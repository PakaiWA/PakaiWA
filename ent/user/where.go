...
func LogoutAt(v time.Time) predicate.User {
	return predicate.User(sql.FieldEQ(FieldLogoutAt, v))
}
...
func LogoutAtEQ(v time.Time) predicate.User {
	return predicate.User(sql.FieldEQ(FieldLogoutAt, v))
}

// LogoutAtNEQ applies the NEQ predicate on the "logout_at" field.
func LogoutAtNEQ(v time.Time) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldLogoutAt, v))
}

// LogoutAtIn applies the In predicate on the "logout_at" field.
func LogoutAtIn(vs ...time.Time) predicate.User {
	return predicate.User(sql.FieldIn(FieldLogoutAt, vs...))
}

// LogoutAtNotIn applies the NotIn predicate on the "logout_at" field.
func LogoutAtNotIn(vs ...time.Time) predicate.User {
	return predicate.User(sql.FieldNotIn(FieldLogoutAt, vs...))
}

// LogoutAtGT applies the GT predicate on the "logout_at" field.
func LogoutAtGT(v time.Time) predicate.User {
	return predicate.User(sql.FieldGT(FieldLogoutAt, v))
}

// LogoutAtGTE applies the GTE predicate on the "logout_at" field.
func LogoutAtGTE(v time.Time) predicate.User {
	return predicate.User(sql.FieldGTE(FieldLogoutAt, v))
}

// LogoutAtLT applies the LT predicate on the "logout_at" field.
func LogoutAtLT(v time.Time) predicate.User {
	return predicate.User(sql.FieldLT(FieldLogoutAt, v))
}

// LogoutAtLTE applies the LTE predicate on the "logout_at" field.
func LogoutAtLTE(v time.Time) predicate.User {
	return predicate.User(sql.FieldLTE(FieldLogoutAt, v))
}
