...
func (_u *UserUpdate) SetLogoutAt(v time.Time) *UserUpdate {
	_u.mutation.SetLogoutAt(v)
	return _u
}

// SetNillableLogoutAt sets the "logout_at" field if the given value is not nil.
func (_u *UserUpdate) SetNillableLogoutAt(v *time.Time) *UserUpdate {
	if v != nil {
		_u.SetLogoutAt(*v)
	}
	return _u
...
// SetLogoutAt sets the "logout_at" field.
func (_u *UserUpdateOne) SetLogoutAt(v time.Time) *UserUpdateOne {
	_u.mutation.SetLogoutAt(v)
	return _u
}

// SetNillableLogoutAt sets the "logout_at" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableLogoutAt(v *time.Time) *UserUpdateOne {
	if v != nil {
		_u.SetLogoutAt(*v)
	}
	return _u
