...
func (_c *PermissionCreate) SetAccess(v string) *PermissionCreate {
...
func (_c *PermissionCreate) SetNillableUserID(id *uuid.UUID) *PermissionCreate {
	if id != nil {
		_c = _c.SetUserID(*id)
	}
	return _c
...
func (_c *PermissionCreate) check() error {
	...
	if _, ok := _c.mutation.Access(); !ok {
		return &ValidationError{Name: "access", err: errors.New(`ent: missing required field "Permission.access"`)}
	}
